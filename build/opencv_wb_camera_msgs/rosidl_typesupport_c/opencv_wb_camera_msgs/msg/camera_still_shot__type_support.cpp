...
static const _CameraStillShot_type_support_symbol_names_t _CameraStillShot_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv_wb_camera_msgs, msg, CameraStillShot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, opencv_wb_camera_msgs, msg, CameraStillShot)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, opencv_wb_camera_msgs, msg, CameraStillShot)() {
  return &::opencv_wb_camera_msgs::msg::rosidl_typesupport_c::CameraStillShot_message_type_support_handle;
}
