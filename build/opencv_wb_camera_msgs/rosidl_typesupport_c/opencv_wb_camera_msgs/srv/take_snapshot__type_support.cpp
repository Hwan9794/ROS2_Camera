...
static const _TakeSnapshot_Request_type_support_symbol_names_t _TakeSnapshot_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv_wb_camera_msgs, srv, TakeSnapshot_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, opencv_wb_camera_msgs, srv, TakeSnapshot_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, opencv_wb_camera_msgs, srv, TakeSnapshot_Request)() {
  return &::opencv_wb_camera_msgs::srv::rosidl_typesupport_c::TakeSnapshot_Request_message_type_support_handle;
}
...
static const _TakeSnapshot_Response_type_support_symbol_names_t _TakeSnapshot_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv_wb_camera_msgs, srv, TakeSnapshot_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, opencv_wb_camera_msgs, srv, TakeSnapshot_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, opencv_wb_camera_msgs, srv, TakeSnapshot_Response)() {
  return &::opencv_wb_camera_msgs::srv::rosidl_typesupport_c::TakeSnapshot_Response_message_type_support_handle;
}
...
static const _TakeSnapshot_type_support_symbol_names_t _TakeSnapshot_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv_wb_camera_msgs, srv, TakeSnapshot)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, opencv_wb_camera_msgs, srv, TakeSnapshot)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, opencv_wb_camera_msgs, srv, TakeSnapshot)() {
  return &::opencv_wb_camera_msgs::srv::rosidl_typesupport_c::TakeSnapshot_service_type_support_handle;
}
