...
#include "opencv_wb_camera_msgs/srv/detail/multi_spawn__type_support.h"
...
static const _MultiSpawn_Request_type_support_symbol_names_t _MultiSpawn_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv_wb_camera_msgs, srv, MultiSpawn_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, opencv_wb_camera_msgs, srv, MultiSpawn_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, opencv_wb_camera_msgs, srv, MultiSpawn_Request)() {
  return &::opencv_wb_camera_msgs::srv::rosidl_typesupport_c::MultiSpawn_Request_message_type_support_handle;
}
...
static const _MultiSpawn_Response_type_support_symbol_names_t _MultiSpawn_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv_wb_camera_msgs, srv, MultiSpawn_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, opencv_wb_camera_msgs, srv, MultiSpawn_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, opencv_wb_camera_msgs, srv, MultiSpawn_Response)() {
  return &::opencv_wb_camera_msgs::srv::rosidl_typesupport_c::MultiSpawn_Response_message_type_support_handle;
}
...
static const _MultiSpawn_type_support_symbol_names_t _MultiSpawn_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv_wb_camera_msgs, srv, MultiSpawn)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, opencv_wb_camera_msgs, srv, MultiSpawn)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, opencv_wb_camera_msgs, srv, MultiSpawn)() {
  return &::opencv_wb_camera_msgs::srv::rosidl_typesupport_c::MultiSpawn_service_type_support_handle;
}
