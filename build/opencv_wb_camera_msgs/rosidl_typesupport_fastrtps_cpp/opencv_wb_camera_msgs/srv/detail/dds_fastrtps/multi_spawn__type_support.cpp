...
#include "opencv_wb_camera_msgs/srv/detail/multi_spawn__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const opencv_wb_camera_msgs::srv::MultiSpawn_Request & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  opencv_wb_camera_msgs::srv::MultiSpawn_Request & ros_message)
{
  // Member: num
  cdr >> ros_message.num;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = opencv_wb_camera_msgs::srv::MultiSpawn_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const opencv_wb_camera_msgs::srv::MultiSpawn_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<opencv_wb_camera_msgs::srv::MultiSpawn_Request *>(
    untyped_ros_message);
...
{
  return &opencv_wb_camera_msgs::srv::typesupport_fastrtps_cpp::_MultiSpawn_Request__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, opencv_wb_camera_msgs, srv, MultiSpawn_Request)() {
  return &opencv_wb_camera_msgs::srv::typesupport_fastrtps_cpp::_MultiSpawn_Request__handle;
}
...
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_opencv_wb_camera_msgs
cdr_serialize(
  const opencv_wb_camera_msgs::srv::MultiSpawn_Response & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  // Member: x
  {
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  opencv_wb_camera_msgs::srv::MultiSpawn_Response & ros_message)
{
  // Member: x
  {
    cdr >> ros_message.x;
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = opencv_wb_camera_msgs::srv::MultiSpawn_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const opencv_wb_camera_msgs::srv::MultiSpawn_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<opencv_wb_camera_msgs::srv::MultiSpawn_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}
...
{
  return &opencv_wb_camera_msgs::srv::typesupport_fastrtps_cpp::_MultiSpawn_Response__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, opencv_wb_camera_msgs, srv, MultiSpawn_Response)() {
  return &opencv_wb_camera_msgs::srv::typesupport_fastrtps_cpp::_MultiSpawn_Response__handle;
}
...
{
  return &opencv_wb_camera_msgs::srv::typesupport_fastrtps_cpp::_MultiSpawn__handle;
}
...
const rosidl_service_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, opencv_wb_camera_msgs, srv, MultiSpawn)() {
  return &opencv_wb_camera_msgs::srv::typesupport_fastrtps_cpp::_MultiSpawn__handle;
}
