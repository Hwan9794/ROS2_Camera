...
#include "opencv_wb_camera_msgs/srv/detail/multi_spawn__rosidl_typesupport_fastrtps_c.h"
...
using _MultiSpawn_Request__ros_msg_type = opencv_wb_camera_msgs__srv__MultiSpawn_Request;
...
size_t get_serialized_size_opencv_wb_camera_msgs__srv__MultiSpawn_Request(
  const void * untyped_ros_message,
...
static uint32_t _MultiSpawn_Request__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_opencv_wb_camera_msgs__srv__MultiSpawn_Request(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_opencv_wb_camera_msgs
size_t max_serialized_size_opencv_wb_camera_msgs__srv__MultiSpawn_Request(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = opencv_wb_camera_msgs__srv__MultiSpawn_Request;
    is_plain =
      (
...
static size_t _MultiSpawn_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_opencv_wb_camera_msgs__srv__MultiSpawn_Request(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv_wb_camera_msgs, srv, MultiSpawn_Request)() {
...
using _MultiSpawn_Response__ros_msg_type = opencv_wb_camera_msgs__srv__MultiSpawn_Response;
...
ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_opencv_wb_camera_msgs
size_t get_serialized_size_opencv_wb_camera_msgs__srv__MultiSpawn_Response(
  const void * untyped_ros_message,
  size_t current_alignment)
{
  const _MultiSpawn_Response__ros_msg_type * ros_message = static_cast<const _MultiSpawn_Response__ros_msg_type *>(untyped_ros_message);
...
{
  return static_cast<uint32_t>(
    get_serialized_size_opencv_wb_camera_msgs__srv__MultiSpawn_Response(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_opencv_wb_camera_msgs
size_t max_serialized_size_opencv_wb_camera_msgs__srv__MultiSpawn_Response(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = opencv_wb_camera_msgs__srv__MultiSpawn_Response;
    is_plain =
      (
...
static size_t _MultiSpawn_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_opencv_wb_camera_msgs__srv__MultiSpawn_Response(
    full_bounded, is_plain, 0);
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv_wb_camera_msgs, srv, MultiSpawn_Response)() {
...
// already included above
// #include "opencv_wb_camera_msgs/msg/rosidl_typesupport_fastrtps_c__visibility_control.h"
#include "opencv_wb_camera_msgs/srv/multi_spawn.h"
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, opencv_wb_camera_msgs, srv, MultiSpawn)() {
