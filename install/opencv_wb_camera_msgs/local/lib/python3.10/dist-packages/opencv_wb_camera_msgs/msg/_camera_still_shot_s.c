...
bool opencv_wb_camera_msgs__msg__camera_still_shot__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("opencv_wb_camera_msgs.msg._camera_still_shot.CameraStillShot", full_classname_dest, 60) == 0);
  }
  opencv_wb_camera_msgs__msg__CameraStillShot * ros_message = _ros_message;
  {  // cmd_vel_linear
...
{
  /* NOTE(esteve): Call constructor of CameraStillShot */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("opencv_wb_camera_msgs.msg._camera_still_shot");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "CameraStillShot");
